...
; For applicative-order evaluation, the test will run an infinite recursion
; since p is defining itself. On normal-order evaluation, the function will
; simply return 0 since the value of p is not evaluated.